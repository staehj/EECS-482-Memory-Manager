...
int main()
{
    ...
    // there is a swap-backed page in between
    ...
    char* between = (char*)vm_map(nullptr, 0); // filename second part
    strcpy(between, "betweenbetweenbetweenbetweenbetweenbetweenbetween");
